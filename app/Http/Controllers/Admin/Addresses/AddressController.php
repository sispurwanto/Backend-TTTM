...
class AddressController extends Controller
{
    ...
    public function create()
    {
        ...
        //$countries = $this->countryRepo->findCountryById(100);
        $country = $this->countryRepo->findCountryById(100);

        $propinsi = $this->provinceRepo->findProvinceById(11);
    ...
    public function store(CreateAddressRequest $request)
    {
        ...
        $request->session()->flash('message', 'Alamat Berhasil dibuat');
