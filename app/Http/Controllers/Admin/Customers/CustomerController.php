...
class CustomerController extends Controller
{
    ...
    public function store(CreateCustomerRequest $request)
    {
        ...
        $this->customerRepo->createCustomer($request->except('_method'));
    ...
    public function update(UpdateCustomerRequest $request, $id)
    {
        ...
        $request->session()->flash('message', 'Customer Berhasil diupdate');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.customers.index')->with('message', 'Hapus Customer Berhasil!');
    }
}
