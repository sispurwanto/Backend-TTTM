            ...
            <form action="{{ route('admin.addresses.update', $address->id) }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="address_1" id="address_1" placeholder="Alamat 1" class="form-control" value="{{ $address->address_1 ?: old('address_1') }}">
                    </div>
                    <div class="form-group">
                        <label for="address_2">Alamat 2 </label>
                        <input type="text" name="address_2" id="address_2" placeholder="Alamat 2" class="form-control" value="{{ $address->address_2 ?: old('address_2') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="zip" id="zip" placeholder="Kode Pos" class="form-control" value="{{ $address->state_code ?: old('state_code') }}">
                    </div>
                    <div class="form-group">
