        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="box-footer">
                    <div class="btn-group">
                        <a class="btn btn-sm btn-primary" href="{{ route('admin.attributes.create') }}"><i class="fa fa-plus"></i> Buat Atribut</a>
                    </div>
                </div>
            @else
                <p class="alert alert-warning">Belum ada Atribut yang dibuat <a href="{{ route('admin.attributes.create') }}">Buat Atribut</a></p>
            @endif
        </div>
        <!-- /.box-body -->
    </div>
