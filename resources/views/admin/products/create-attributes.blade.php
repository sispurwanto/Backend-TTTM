...
<div class="form-group">
    ...
    <input type="number" name="productAttributeQuantity" id="productAttributeQuantity" class="form-control" placeholder="Set quantity" disabled>
</div>
<div class="form-group">
    <label for="productAttributePrice">Harga</label>
...
<div class="form-group">
    <label for="salePrice">Harga Jual</label>
    <div class="input-group">
        <!--<span class="input-group-addon">{{ config('cart.currency') }}</span>-->
...
<div class="form-group">
    <label for="default">Tampilkan sebagai harga default?</label> <br />
...
<div class="box-footer">
    <div class="btn-group">
        <button type="button" class="btn btn-sm btn-default" onclick="backToInfoTab()">Kembali</button>
        <button id="createCombinationBtn" type="submit" class="btn btn-sm btn-primary" disabled="disabled">Buat Kombinasi</button>
    </div>
</div>