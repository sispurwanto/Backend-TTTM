                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist" id="tablist">
                                <li role="presentation" @if(!request()->has('combination')) class="active" @endif><a href="#info" aria-controls="home" role="tab" data-toggle="tab">Info Produk</a></li>
                                <li role="presentation" @if(request()->has('combination')) class="active" @endif><a href="#combinations" aria-controls="profile" role="tab" data-toggle="tab">Kombinasi</a></li>
                            </ul>
                            <!-- Tab panes -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="text-warning">Kamu dapat menekan tombol CTRL untuk memilih beberapa Image</span>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                @else
                                                    ...
                                                    <input type="number" value="{{ $qty }}" class="form-control" disabled>
                                                @endif
                                                @if(!$productAttributes->isEmpty())<span class="text-danger"><!--Note: Quantity is disabled. Total quantity is calculated by the sum of all the combinations.-->Catatan: Quantity dinonaktifkan. Quantity total dihitung dengan jumlah semua kombinasi</span> @endif
                                            </div>
                                            <div class="form-group">
                                                ...
                                                @endif
                                                @if(!$productAttributes->isEmpty())<span class="text-danger"><!--Note: Price is disabled. Price is derived based on the combination.-->Catatan: Harga dinonaktifkan. Harga diturunkan berdasarkan kombinasi.</span> @endif
                                            </div>
                                            <div class="form-group">
...
@section('js')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#productAttributePrice').autoNumeric('init');
            $('#salePrice').autoNumeric('init');
