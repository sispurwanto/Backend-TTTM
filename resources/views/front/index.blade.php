...
@section('content')
    ...
    @if($cat1->products->isNotEmpty())
        <section class="new-product t100 home">
            <div class="container">
                ...
                <div id="browse-all-btn"> <a class="btn btn-default browse-all-btn" href="{{ route('front.category.slug', $cat1->slug) }}" role="button">Lihat Semua Item</a></div>
            </div>
        </section>
    @else
    <section class="new-product t100 home">
    ...
    @if($cat2->products->isNotEmpty())
        <div class="container">
            ...
            <div id="browse-all-btn"> <a class="btn btn-default browse-all-btn" href="{{ route('front.category.slug', $cat2->slug) }}" role="button">Lihat Semua Item</a></div>
        </div>
     @else
    <section class="new-product t100 home">
            <div class="container">
