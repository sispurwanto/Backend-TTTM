            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">contoh ada 4 pesan belum dibaca</li>
                        <li>
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">contoh ada 10 Notifikasi</li>
                        <li>
                            <!-- inner menu: contains the actual data -->
                            <ul class="menu">
                                <li>
                                    <a href="#">
                                        <i class="fa fa-users text-aqua"></i> ada 5 Member baru join di hari ini
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="dropdown tasks-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">contoh ada 9 transaksi sedang proses</li>
                        <li>
                            <!-- inner menu: contains the actual data -->
                            <ul class="menu">
                                <li><!-- Task item -->
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                {{ $user->name }}
                                <!--<small>Level :  {{ $user->created_at }}</small>-->
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <!--<li class="user-body">
